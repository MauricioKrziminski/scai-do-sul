...
| 2026-08-19 | Botão do WhatsApp: só o glifo oficial, sem fundo, no verde #25D366 | Decisão do Mauricio. É a única cor fora da paleta do site, e está aí porque é marca de terceiro. Medido: 1.70:1 sobre o papel e 7.70:1 sobre o escuro. Nas seções claras fica suave, e a saída, se incomodar, é devolver o fundo sólido |
| 2026-08-19 | "Onde estamos" com endereço à esquerda e mapa à direita | O padrão de rótulo estreito à esquerda não serve com um mapa largo: metade da tela ficava vazia, o que lê como desalinhamento e não como respiro |
